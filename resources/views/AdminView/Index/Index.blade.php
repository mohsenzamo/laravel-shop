                                            ...
                                            <div class="media-body text-right mt-2">
                                                <ul class="list-unstyled users-list">
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="برات هادیان" class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="/AdminCss/app-assets/images/portrait/small/avatar-s-19.png" alt="Avatar">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="کاترین نیکولس" class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="/AdminCss/app-assets/images/portrait/small/avatar-s-18.png" alt="Avatar">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="جوزف ویور" class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="/AdminCss/app-assets/images/portrait/small/avatar-s-17.png" alt="Avatar">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table table-padded table-xl mb-0" id="recent-project-table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled users-list m-0">
                                                    ...
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="کاترین نیکولس" class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="/AdminCss/app-assets/images/portrait/small/avatar-s-14.png" alt="Avatar">
                                                    </li>
                                                </ul>
                                            </td>
                                            <td class="text-truncate pb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled users-list m-0">
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="برات هادیان" class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="/AdminCss/app-assets/images/portrait/small/avatar-s-11.png" alt="Avatar">
                                                    </li>
                                                    <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="کاترین نیکولس" class="avatar avatar-sm pull-up">
                                                        <img class="media-object rounded-circle" src="/AdminCss/app-assets/images/portrait/small/avatar-s-12.png" alt="Avatar">
                                                    </li>
                                                </ul>
                                            </td>
                                            <td class="text-truncate pb-0">
                                        ...
                                        <div class="chat">
                                            <div class="chat-avatar">
                                                <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                    <img src="/AdminCss/app-assets/images/portrait/small/avatar-s-19.jpg" alt="avatar" />
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                    <img src="/AdminCss/app-assets/images/portrait/small/avatar-s-15.jpg" alt="avatar" />
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-content">
