...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/AdminCss/app-assets/css-rtl/pages/login-register.min.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            <div class="card-header border-0">
                                <div class="text-center mb-1">
                                    <img src="/AdminCss/app-assets/images/logo/logo.png" alt="branding logo">
                                </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="index.html" novalidate>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-name" placeholder="نام کاربری شما" required>
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control round" id="user-password" placeholder="رمز عبور را وارد کنید" required>
                                            <div class="form-control-position">
                                                <i class="ft-lock"></i>
                                            </div>
                                        </fieldset>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-12 float-sm-left text-center text-sm-right"><a href="recover-password.html" class="card-link">رمز عبور را فراموش کردید؟</a></div>
                                        </div>
                                ...
                                <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1"><span>حساب کاربری ندارید؟ <a href="{{route('RegisterAdminViewRoute')}}" class="card-link">ثبت نام</a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="/AdminCss/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js" type="text/javascript"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="/AdminCss/app-assets/js/scripts/forms/form-login-register.min.js" type="text/javascript"></script>
<!-- END: Page JS-->
