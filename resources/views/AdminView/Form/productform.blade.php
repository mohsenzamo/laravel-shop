                ...
                <div class="col-xl-12 col-lg-24">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="file-repeater">ایجاد محصول</h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form class="form row" action="{{route('AddProductRout')}}"   method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group col-md-6 mb-2">
                                        <input type="text" class="form-control" placeholder="نام محصول" name="name">
                                    </div>
                                    <div class="form-group col-md-6 mb-2">
                                        <input type="text" class="form-control" placeholder="عنوان" name="cat">
                                    </div>
                                    <div class="form-group col-md-6 mb-2">
                                    ...
                                    <div>
                                        <button type="submit" class="btn btn-primary">
                                            <i class="ft-plus"></i> اضافه کردن محصول
                                        </button>
                                    </div>
