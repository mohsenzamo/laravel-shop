            ...
            <div class="col-lg-6 col-md-12">
                <div class="about-content">
                    <div class="section-title">
                        <h2>فرایند ما ساده است؛ محصولات ما قدرتمند هستند.</h2>
                        <div class="bar"></div>
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. لورم ایپسوم.</p>
                    </div>
                    ...
                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت.</p>
                </div>
            </div>
            ...
            <div class="team-slides">
                <div class="col-lg-12">
                    <div class="single-team-member">
                        <img src="/ClientCss/assets/img/team-img1.jpg" alt="team">
                ...
                <div class="col-lg-12">
                    <div class="single-team-member">
                        <img src="/ClientCss/assets/img/team-img2.jpg" alt="team">
                ...
                <div class="col-lg-12">
                    <div class="single-team-member">
                        <img src="/ClientCss/assets/img/team-img3.jpg" alt="team">
                ...
                <div class="col-lg-12">
                    <div class="single-team-member">
                        <img src="/ClientCss/assets/img/team-img4.jpg" alt="team">
                ...
                <div class="col-lg-12">
                    <div class="single-team-member">
                        <img src="/ClientCss/assets/img/team-img5.jpg" alt="team">
    ...
    <div class="container">
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-lg-7 col-md-7">
                <p>میخواهید فوق العاده شید؟ جای مناسبی اومدید!</p>
            </div>
            ...
            <div class="feedback-slides">
                <div class="col-lg-12">
                    <div class="single-feedback">
                        ...
                        <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. لورم ایپسوم متن ساختگی با تولید سا.</p>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <h2>تعامل با کاربران خود در هر پلتفرم های متفاوت</h2>
            </div>

            <div class="col-lg-3 col-md-6">
                <a href="#" class="box">
                    <img src="/ClientCss/assets/img/mailchimp.png" alt="mailchimp">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" class="box">
                    <img src="/ClientCss/assets/img/slack.png" alt="mailchimp">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" class="box">
                    <img src="/ClientCss/assets/img/twitter.png" alt="mailchimp">
            ...
            <div class="col-lg-3 col-md-6">
                <a href="#" class="box">
                    <img src="/ClientCss/assets/img/instagram.png" alt="mailchimp">
